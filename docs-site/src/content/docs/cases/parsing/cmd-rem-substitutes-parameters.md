...
description: "parsing landmine — hard-error (both)"
sidebar:
  label: "CMD rem substitutes parameters"
---

<p class="case-eyebrow">parsing · case</p>

<div class="case-badges"><span class="badge badge-version">both</span><span class="badge badge-failure-hard-error">hard-error</span><span class="badge badge-context">agent</span><span class="badge badge-context">script</span><span class="badge badge-context">ci</span><span class="badge badge-meta">third-party</span><span class="badge badge-meta">repro: verified</span><a class="badge badge-mech" href="/fuck-powershell/ontology/mechanisms/#rem-parameter-substitution">rem-parameter-substitution</a></div>

<div class="case-glance"><div class="row"><span class="k">Affects</span><span class="v">cmd, windows</span></div><div class="row"><span class="k">Fails as</span><span class="v">INVALID BATCH SUBSTITUTION</span></div><div class="row"><span class="k">Mechanism</span><span class="v">rem parameter substitution</span></div><div class="row"><span class="k">Safe fix</span><span class="v"><span class="fix">comment outside batch</span></span></div></div>

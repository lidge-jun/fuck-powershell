...
sidebar:
  label: "dot sh association exits zero"
---

<p class="case-eyebrow">env paths · case</p>

<div class="case-badges"><span class="badge badge-version">both</span><span class="badge badge-failure-silent">silent</span><span class="badge badge-context">agent</span><span class="badge badge-context">ci</span><span class="badge badge-context">script</span><span class="badge badge-meta">third-party</span><span class="badge badge-meta">repro: verified</span><a class="badge badge-mech" href="/fuck-powershell/ontology/mechanisms/#inert-file-association">inert-file-association</a></div>

<div class="case-glance"><div class="row"><span class="k">Affects</span><span class="v">cmd, powershell 51, windows</span></div><div class="row"><span class="k">Fails as</span><span class="v">EFTYPE</span></div><div class="row"><span class="k">Mechanism</span><span class="v">inert file association</span></div><div class="row"><span class="k">Safe fix</span><span class="v"><span class="fix">dispatch by declared interpreter</span></span></div></div>

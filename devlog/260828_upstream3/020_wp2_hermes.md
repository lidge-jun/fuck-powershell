...
| sha | disposition |
|---|---|
| 9e23ebdd | REF python-utf8-bom-not-sig |
| c283b164 | REJECT repo-specific |
| 6044e706 | REF python-utf8-bom-not-sig |
| 2ac58432 | REJECT no-windows-mechanism |
| 4bdddf4e | REJECT docs-only |
| 70598f52 | REJECT repo-specific |
| 341d5aeb | NEW python-open-utf16le |
| dde7075d | REF python-utf8-bom-not-sig |
| 3af56c22 | REJECT repo-specific |
| 5e8d25d7 | NEW msys-posix-drive-path |
...
| 1156ba43 | REF msys-posix-drive-path |
| 10e9da6f | REF bom-less-ps1-cp949 |
| 323df71e | NEW cmd-caret-escapes-next |
| 2cd9e177 | REJECT repo-specific |
| 5b5b5e8d | NEW python-subprocess-locale-encoding |
| 9dcce84c | REF redirected-ps-output-mojibake |
| 9e6cfcda | REF python-utf8-bom-not-sig |
| 3fee5c29 | REJECT test-only |
| f2feb6f3 | REF python-utf8-bom-not-sig |
| ece678db | REF python-utf8-bom-not-sig |
| b76498ba | REF python-utf8-bom-not-sig |
| aa1fac98 | NEW python-utf8-bom-not-sig |
| a024ccd6 | REJECT test-only |
| 022d196f | REJECT no-windows-mechanism |
| 36f73df1 | REF python-utf8-bom-not-sig |
| 0c2cdccc | REJECT repo-specific |
| 55e70f57 | REJECT test-only |
| dae7e547 | REJECT test-only |
| eb78ab23 | REF python-utf8-bom-not-sig |
| 696fae8e | REF python-utf8-bom-not-sig |
...
| 0a6fda01 | REF python-utf8-bom-not-sig |
...
| 7d597cc5 | REF python-open-utf16le |
| 97249cfc | REF bom-less-ps1-cp949 |
| edfa4cd9 | REF python-utf8-bom-not-sig |
| f3612328 | REF python-utf8-bom-not-sig |
| 51e1fb8f | REF python-utf8-bom-not-sig |
| fb0217c6 | REJECT no-windows-mechanism |
| 780e0980 | REF python-utf8-bom-not-sig |
| a4ecb3da | REF python-utf8-bom-not-sig |
| 7886c5d6 | REJECT repo-specific |
| 651bd989 | REJECT no-windows-mechanism |
| f0d22e4b | REJECT test-only |
| 3f8b2200 | REF msys-posix-drive-path |
...
| a2d49de8 | REF msys-arg-path-conversion |
| 51c01062 | REJECT test-only |
| cc2abd57 | NEW msys-arg-path-conversion |
| b7c4369c | REJECT no-windows-mechanism |
| aa2aac68 | REF zip-entry-drive-letter-escapes |
| e74033b3 | NEW ps-provider-8.3-tilde |
...
| 5f84c914 | REF python-utf8-bom-not-sig |
...
| eeb723ff | NEW python-start-new-session-noop |
...
| 453e0677 | NEW drive-letter-colon-split |
...
| #87542 | NEW msys-arg-path-conversion |
| #85659 | REJECT no-windows-mechanism |
| #44567 | REJECT repo-specific |
| #86204 | REF python-start-new-session-noop |
...
| #58275 | REF python-start-new-session-noop |
...
| #43073 | REF bash-eats-windows-backslash |
| #49500 | REJECT repo-specific |
| #92271 | NEW colon-illegal-in-filename |
...
| #85265 | REF python-start-new-session-noop |
| #63717 | REJECT repo-specific |
| #76259 | NEW non-pe-exe-16bit-dialog |
...
| #86166 | REF colon-illegal-in-filename |
...
| #51215 | REF python-start-new-session-noop |
...
| #68128 | NEW job-object-forbids-breakaway |

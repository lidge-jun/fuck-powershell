---
id: aside-sync-resources-outlive-isolate-file
...
ontology:
  affects: [runtime-bun, env-actions-runner]
  manifests_as: [error-test-timeout]
  caused_by: [mechanism-test-resource-outlives-file]
  mitigated_by: [workaround-own-request-deadline-and-teardown]
  unsafe_fix: [workaround-mask-isolate-resource-leak]
  related_to: [case:test-budget-sized-from-local-timing]
---

# A stale Aside sync timer and socket outlive their test file in a shared Bun isolate

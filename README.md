...
- **Cases**: [cases/](cases/) — one markdown file per landmine, YAML frontmatter
  (category, affected versions, failure mode, context).
...
```yaml
id: curl-alias                 # must equal filename stem, unique

...
109 reproducible cases of Windows shell & process landmines — alias traps, spawn
...
(383 nodes, 804 edges) that an agent can QUERY BEFORE PATCHING instead of
...
|---|---|---|
| Cases | 109 markdown files, canonical source of truth | [cases/](cases/) |

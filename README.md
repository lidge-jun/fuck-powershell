...
54 reproducible cases of Windows shell & process landmines — alias traps, spawn
semantics, PATH/PATHEXT resolution, encodings, exit codes, cmd.exe re-parsing,
PowerShell 5.1 legacy behavior — bound into a typed ontology (211 nodes,
428 edges) that an agent can QUERY BEFORE PATCHING instead of debugging after
the explosion. PowerShell is the brand; the corpus is the whole Windows
interop minefield.
...
|---|---|---|
| Cases | 54 markdown files, canonical source of truth | [cases/](cases/) |
